        ...
        <div className="navbar m-3 max-w-7xl mx-auto">
            <div className="flex h-full w-full justify-around items-center align-middle">
                ...
                <div className="flex gap-10 overflow-hidden">
                    <input type="checkbox" checked={colorFilter.red} onClick={_ => setColorFilter(prev => {return {...prev, red: !prev.red}})} className="checkbox [--chkbg:theme(colors.red.400)] [--chkfg:black]" />
                    <input type="checkbox" checked={colorFilter.blue} onClick={_ => setColorFilter(prev => {return {...prev, blue: !prev.blue}})} className="checkbox [--chkbg:theme(colors.sky.400)] [--chkfg:black]" />
                    <input type="checkbox" checked={colorFilter.white} onClick={_ => setColorFilter(prev => {return {...prev, white: !prev.white}})} className="checkbox [--chkbg:theme(colors.amber.200)] [--chkfg:black]" />
                    <input type="checkbox" checked={colorFilter.green} onClick={_ => setColorFilter(prev => {return {...prev, green: !prev.green}})} className="checkbox [--chkbg:theme(colors.green.400)] [--chkfg:black]" />
                    <input type="checkbox" checked={colorFilter.black} onClick={_ => setColorFilter(prev => {return {...prev, black: !prev.black}})} className="checkbox [--chkbg:theme(colors.gray.500)] [--chkfg:black]" />
                </div>
